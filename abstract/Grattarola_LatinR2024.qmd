---
title: "`reportiNat`: creación de reportes de proyectos de iNaturalist usando `quarto`"
format: pdf
author:
...
citation:
  ...
  genre: talk
  publisher: LatinR
  container-title: LatinR
  issued: 2024
self-contained: true
---

**Palabras clave**: biodiversidad, ciencia participativa, API, NaturalistaUY
